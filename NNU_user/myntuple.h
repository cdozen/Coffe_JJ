...
// Sat Jul 11 02:45:29 2020 by ROOT version 6.06/01
// from TTree X_data/X(3872) Data
// found on file: /eos/uscms/store/user/lpcbphy/yik/JJntuple/PythiaDPSntupleLJF/DPSTo4mu_13TeV_pythia8/crab_PythiaDPStoJJto4mu_ntupleLJF/200709_133152/0000/mymultilep_1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      //TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/eos/uscms/store/user/lpcbphy/yik/JJntuple/PythiaDPSntupleLJF/DPSTo4mu_13TeV_pythia8/crab_PythiaDPStoJJto4mu_ntupleLJF/200709_133152/0000/mymultilep_1.root");
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("mymultilep_SPS_test.root");
      if (!f || !f->IsOpen()) {
         //f = new TFile("/eos/uscms/store/user/lpcbphy/yik/JJntuple/PythiaDPSntupleLJF/DPSTo4mu_13TeV_pythia8/crab_PythiaDPStoJJto4mu_ntupleLJF/200709_133152/0000/mymultilep_1.root");
         f = new TFile("mymultilep_SPS_test.root");
      }
      //TDirectory * dir = (TDirectory*)f->Get("/eos/uscms/store/user/lpcbphy/yik/JJntuple/PythiaDPSntupleLJF/DPSTo4mu_13TeV_pythia8/crab_PythiaDPStoJJto4mu_ntupleLJF/200709_133152/0000/mymultilep_1.root:/mkcands");
      TDirectory * dir = (TDirectory*)f->Get("mymultilep_SPS_test.root");
